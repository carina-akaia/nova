...
function template(html, isImportNode, isSVG) {
  ...
  const fn = isImportNode ? () => untrack(() => document.importNode(node || (node = create5()), true)) : () => (node || (node = create5())).cloneNode(true);
  fn.cloneNode = fn;
  return fn;
}
...
var Button = (props) => {
  ...
  return createComponent(index$w.Root, mergeProps({
    get ["class"]() {
...
var _tmpl$ = /* @__PURE__ */ template(`<div><h1></h1><div><h2>props</h2><code>`);
var ExampleExtension = () => {
  ...
  return (() => {
    ...
    _el$.style.setProperty("gap", "2rem");
    insert(_el$2, () => `
    ...
    insert(_el$5, (() => {
      var _c$ = createMemo(() => ctx.props !== null);
      return () => _c$() && JSON.stringify(ctx.props, null, 2);
    })());
...
var _tmpl$2 = /* @__PURE__ */ template(`<link rel=stylesheet href=/app/akaia_nova.css>`);
...
var install = () => {
  if (customElements.get(tagName) === void 0) {
    customElements.define(tagName, class AkaiaExtension extends HTMLElement {
      ...
      connectedCallback() {
        render(() => {
          console.log(db);
          return createComponent(ExtensionContext.Provider, {
            value: extensionContextState,
            get children() {
              return [_tmpl$2(), createComponent(ExampleExtension, {})];
            }
          });
        }, this.attachShadow({
          mode: "closed"
